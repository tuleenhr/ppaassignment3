...
public class Berry extends Plant {
    private static final double GROWTH_PROBABILITY = 0.6;  // 40% chance to grow each step
    private static final double SPREADING_PROBABILITY = 0.3;  // 20% chance to spread
